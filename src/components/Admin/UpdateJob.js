...
class UpdateJob extends Component {
    ...
    onSubmit = () => {
        ...
        axios.patch(path, jobDetails).then((res) => {
                    ...
                    <div className='form-card'>
                        ...
                        <div className='form-section'>
                            ...
                            <div className='form-buttons'>
                                <button className='btn' onClick={this.onSubmit}>Update Job Details</button>
                                <NavLink to='/admin-job-details' className='center back-btn'>Back</NavLink>
                            </div>
